...
namespace System.Windows.Forms
{
    ...
    public class CustomTabControl : TabControl
    {
        ...
        public override Rectangle DisplayRectangle
        {
            get
            {
                ...
                else
                {
                    ...
                    int tabStripHeight = 5 + (itemHeight*this.RowCount);
        ...
        public int ActiveIndex
        {
            ...
            {
                var hitTestInfo =
                    new NativeMethods.TCHITTESTINFO(this.PointToClient(Control.MousePosition));
                int index =
                    NativeMethods.SendMessage(this.Handle, NativeMethods.TCM_HITTEST, IntPtr.Zero,
        ...
        protected override void WndProc(ref Message m)
        {
            switch (m.Msg)
            {
                case NativeMethods.WM_HSCROLL:
                    ...
                    base.WndProc(ref m);
                    this.OnHScroll(new ScrollEventArgs(((ScrollEventType) NativeMethods.LoWord(m.WParam)), _oldValue,
...
//					break;
        ...
        protected override void OnMouseClick(MouseEventArgs e)
        {
            ...
            else if (!this.DesignMode && index > -1 && this._StyleProvider.ShowTabCloser &&
...
//		}
        ...
        private void CustomPaint(Graphics screenGraphics)
        {
            ...
            if (this.Width > 0 && this.Height > 0)
            {
                ...
                if (this.TabCount > 0)
                {
                    ...
                    {
                        this._TabBufferGraphics.Clip =
                            new Region(new RectangleF(this.ClientRectangle.X + 3, this.ClientRectangle.Y,
                                                      this.ClientRectangle.Width - 6, this.ClientRectangle.Height));
                    }
                ...
                using (var alphaAttributes = new ImageAttributes())
                {
                    ...
                    this._BackBufferGraphics.DrawImage(this._TabBuffer,
                                                       ...
                                                       0, 0, this._TabBuffer.Width, this._TabBuffer.Height,
                                                       GraphicsUnit.Pixel,
                                                       alphaAttributes);
                }
        ...
        private void DrawTabText(int index, Graphics graphics)
        {
            ...
            if (this.SelectedIndex == index)
            {
                ...
                {
                    graphics.DrawString(this.TabPages[index].Text, this.Font, textBrush, tabBounds,
        ...
        private void DrawTabImage(int index, Graphics graphics)
        {
            ...
            if (this.TabPages[index].ImageIndex > -1 && this.ImageList != null &&
                this.ImageList.Images.Count > this.TabPages[index].ImageIndex)
            {
            ...
            using (GraphicsPath path = this._StyleProvider.GetTabBorder(index))
            {
                ...
                if (this.ImageList != null && (this.TabPages[index].ImageIndex > -1
                                               || (!string.IsNullOrEmpty(this.TabPages[index].ImageKey)
                                                   &&
                                                   !this.TabPages[index].ImageKey.Equals("(none)",
                                                                                         StringComparison.
                                                                                             OrdinalIgnoreCase))))
                {
                    Rectangle imageRect = this.GetTabImageRect(index);
